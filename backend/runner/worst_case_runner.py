...
async def run_worst_case_tracking(
    ...
    if not decisions:
        ...
        empty_report = compute_worst_case_report([], top_n=DEFAULT_TOP_N, computed_at_utc=datetime.now(timezone.utc))
        write_csv(empty_report, csv_path, top_n=DEFAULT_TOP_N)
        write_json(empty_report, json_path, top_n=DEFAULT_TOP_N)
