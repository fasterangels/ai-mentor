...
# Injury shadow (shadow-only; no pipeline logic yet)
INJ_MULTIPLE_OUT = "INJ_MULTIPLE_OUT"
INJ_HIGH_UNCERTAINTY = "INJ_HIGH_UNCERTAINTY"
INJ_CONFLICT_PRESENT = "INJ_CONFLICT_PRESENT"
INJ_COVERAGE_LOW = "INJ_COVERAGE_LOW"
INJ_KEY_PLAYER_OUT = "INJ_KEY_PLAYER_OUT"  # reserved for later
...
ALL_REASON_CODES = frozenset({
    ...
    INJ_MULTIPLE_OUT, INJ_HIGH_UNCERTAINTY, INJ_CONFLICT_PRESENT, INJ_COVERAGE_LOW, INJ_KEY_PLAYER_OUT,
})
